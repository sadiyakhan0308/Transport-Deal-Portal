	...
	<div class="header-top-w3layouts">
		<div class="container">
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						<c:forEach var="transporter" items="${transportersdeal}">
							<tr>
								<td>${transporter.dealstartdate}</td>
								<td>${transporter.dealenddate}</td>
								<td>${transporter.vehicleregno}</td>
								<td>${transporter.vehiclemodel}</td>
								<td>${transporter.pickupcity}</td>
								<td>${transporter.dropcity}</td>
								<td>${transporter.price}</td>
								<td>${transporter.vehiclecapacity}</td>
