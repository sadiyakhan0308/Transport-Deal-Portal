...
body {
	...
	background: url(./images/road.jpg) no-repeat;background-size:cover;
...
<div class="header-top-w3layouts">
	...
	<form name="myform" action="savecustomer" method='post' 
		...
		<table align="center">
			...
			<tr>
				...
				<h2 align="center" style="color:white">Welcome Customer</h2>
			</tr>
			<br>
			<tr>
				<td>Email-id</td>
