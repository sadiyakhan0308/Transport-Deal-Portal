					...
					<tr>
						<c:forEach var="transporter" items="${transporters}">
							<tr>
								...
								<td>${transporter.orgname}</td>
								<td><a href="LoadDocs?file=${transporter.orgdocs}"
									style="color: white" target="blank" name ="file">View</a></td>
								<td><a href="LoadDocs?file=${transporter.identity}"
									style="color: white" target="blank">View</a></td>
								<td><a href="approve?email=${transporter.email}">Approve <span class="glyphicon glyphicon-ok"></span>
								</a></td>
								<td><a href="reject"> <span
