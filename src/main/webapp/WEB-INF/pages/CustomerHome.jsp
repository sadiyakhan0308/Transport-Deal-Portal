					...
					<nav class="navbar navbar-expand-lg navbar-light">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-lg-auto text-right">
								...
								<li class="nav-item"><a class="nav-link" href="viewcusdeals">View All Deals</a>
								</li>

									
								<li class="nav-item"><a class="nav-link" href="updatecustomer">Update Profile</a>
								</li>
								<li class="nav-item"><a class="nav-link"
									href="querytransporter">Contact Transporter</a></li>
